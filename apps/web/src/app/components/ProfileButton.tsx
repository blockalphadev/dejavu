...
export function ProfileButton({ user, mobile, triggerOnly, children, onNavigate }: ProfileButtonProps) {
        ...
        <>
            ...
            <DropdownMenu>
                ...
                <DropdownMenuContent align="end" className="w-56 p-2">
                    ...
                    <DropdownMenuSeparator />
                    <DropdownMenuItem onClick={() => onNavigate?.('dashboards')} className="cursor-pointer">
