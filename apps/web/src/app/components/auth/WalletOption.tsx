...
export function WalletOption({ icon, name, recommended, installed = true, isMobile = false, className, ...props }: WalletOptionProps) {
    ...
    return (
        <button
            ...
            {...props}
        >
            <div className="flex h-10 w-10 items-center justify-center rounded-lg bg-background/80 shadow-sm ring-1 ring-border/50 transition-transform group-hover:scale-110">
