...
// Market categories supported for streaming
...
export class MarketMessagingService implements OnModuleInit, OnModuleDestroy {
            ...
            await this.channel.consume(queueName, (msg: any) => {
                if (msg) {
                    try {
                        ...
                        this.handleMessage(category, content);
     ...
     */
    private handleMessage(category: MarketCategory, content: unknown): void {
        // Validate message
        ...
        const message: MarketMessage = {
            ...
            data: this.sanitizeData(content),
