...
const VALID_CATEGORIES = ['politics', 'finance', 'tech', 'crypto', 'economy', 'science', 'signals', 'latest'] as const;
type MarketCategory = typeof VALID_CATEGORIES[number];

// Security configuration
const SECURITY_CONFIG = {
    maxSubscriptionsPerClient: 10,
    maxMessageSizeBytes: 1024 * 10, // 10KB
    rateLimitPerSecond: 10, // Max 10 requests per second per client
