...
export function Sidebar({ isOpen, onClose }: SidebarProps) {
  return (
    <>
      ...
      {/* Sidebar */}
      <aside
        className={`fixed lg:sticky top-0 right-0 h-screen w-80 bg-card border-l border-border z-50 lg:z-0 transition-transform duration-300 lg:translate-x-0 overflow-y-auto custom-scrollbar ${
